...
class NewRegistrar extends StatefulWidget {
  const NewRegistrar({super.key});
  @override
  State<NewRegistrar> createState() => _NewRegistrarState();
}

class _NewRegistrarState extends State<NewRegistrar> {
...
//throwing everything to the firestore
    ...
    newDocRef.set({
      ...
      'date': _selectdate!,
      'in_time': DateFormat.jm().format(DateTime.now()),
